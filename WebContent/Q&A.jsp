...
<body>
	...
	%>
	<form method = "post" action = "QARegi.jsp" name = "QAForm">			
	<p>
	<div class = "h"> Q&A </div>
	<div class = "m"> 질문응답 </div>
	<input type = "image" src = "img/REGISTER.png" name = "submit" value = "submit" class = "n" width = "100" />
		<table align = "center">
 			<tr>
			...
			%>
				<td align = "center"> 
	         	...
	         	<td> 
	         		<a href = "QAcontext.jsp?qid=<%= rs.getString("qid")%>">
