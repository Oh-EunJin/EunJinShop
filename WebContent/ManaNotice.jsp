...
<body>
	...
	%>
	<form method = "post" action = "NotiRegi.jsp" name = "NotiForm">			
	<p>
	<div class = "h"> Notice </div>
	<div class = "m"> 공지사항 </div>
	<input type = "image" src = "img/NOTI.png" name = "submit" value = "submit" class = "n" width = "100" />
		<table align = "center">
 			<tr>
			...
			<% while(rs.next()) { %>
				<td align = "center"> 
	         	...
	         	<td> 
	         		<a href = "NotiM&R.jsp?nid=<%= rs.getString("nid")%>">
